...
lock_screen_box.bg = beautiful.bg_dark .. "aa"
lock_screen_box.fg = beautiful.fg
...
awful.screen.connect_for_each_screen(function(s)
  if s == screen.primary then
    ...
    s.mylockscreen = helpers.ui.screen_mask(s, beautiful.bg_dark or beautiful.bg_dark1)
  end
end)
...
for i, m in pairs(time_char) do
  local text = helpers.ui.colorize_text(m, beautiful.fg_gutter .. "99")
...
local function deactivate_word(w)
  for _, m in pairs(char_map[w]) do
    local text = m.text
    m.markup = helpers.ui.colorize_text(text, beautiful.fg_gutter .. "99")
  end
end
